...
const routes = [
  ...
  { name: 'iImgCut', path: '/iImgCut', component: iImgCut, type: 'components', icon: 'scissors', txt: '图片裁剪' },
  { name: 'iFireWorks', path: '/iFireWorks', component: iFireWorks, type: 'components', icon: 'ios-snowy', txt: '飘雪花' },
