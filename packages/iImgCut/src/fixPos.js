...
export function _fixedDrawSize () {
  ...
  let imageRatio = this.resPos.sw / this.resPos.sh
  let containerRatio = this.drawPos.dw / this.drawPos.dh
  // 当图片比较宽
  if (imageRatio > containerRatio) {
    this.drawPos.dw = this.drawPos.dh * imageRatio
    ...
    // 当图片比较高
    this.drawPos.dh = this.drawPos.dw / imageRatio
...
export function _fixedCenterPic () {
    // todo:
    // http://githost.in66.cc/ued/res/blob/master/core/js/module/imageHandle.js
}
